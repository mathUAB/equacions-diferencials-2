...
\begin{center}
  \begin{minipage}{0.47\linewidth}
    \centering
    \includestandalone[mode=image|tex,width=\linewidth]{Images/retrat_a+b+}
    \captionof{figure}{Retrat de fase del sistema en el cas particular $a=2$ i $b=1.5$}
  \end{minipage}\hfill
  \begin{minipage}{0.47\linewidth}
    \centering
    \includestandalone[mode=image|tex,width=\linewidth]{Images/retrat_a-b-}
    \captionof{figure}{Retrat de fase del sistema en el cas partícular $a=0.7$ i $b=0.2$}
  \end{minipage}\vspace{0.02\linewidth}
  \begin{minipage}{0.47\linewidth}
    \centering
    \includestandalone[mode=image|tex,width=\linewidth]{Images/retrat_a+b-}
    \captionof{figure}{Retrat de fase del sistema en el cas partícular $a=1.3$ i $b=0.8$}
  \end{minipage}\hfill
  \begin{minipage}{0.47\linewidth}
    \centering
    \includestandalone[mode=image|tex,width=\linewidth]{Images/retrat_a-b+}
    \captionof{figure}{Retrat de fase del sistema en el cas partícular $a=0.7$ i $b=1.8$}
  \end{minipage}
\end{center}
...
\begin{center}
  \begin{minipage}{\linewidth}
    \centering
    \includestandalone[mode=image|tex,width=0.65\linewidth]{Images/retrat_c}
    \captionof{figure}{Retrat de fase del sistema en el cas particular de $a=1$ i $b=1$}
  \end{minipage}
\end{center}
\newpage
\section*{Problema 2}
